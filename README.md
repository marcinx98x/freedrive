...
- Independent release tags: `desktop-v0.1.87` (server tags remain `v1.x.x`)
...
- **0.1.87+** — Cloud file thumbnails: encrypted JPEG thumbs at upload (web/mobile/desktop); Explorer ThumbnailProvider (`freedrive_thumb.dll`) for online-only My Drive previews; idle desktop backfill; `PUT/GET /api/v1/files/{id}/thumbnail`
